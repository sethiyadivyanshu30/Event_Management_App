...
class _ValorantState extends State<Valorant> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: "VALORANT".text.color(Colors.tealAccent).make(),
        centerTitle: true,
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            const Text("Valorant-the Valorant Tournament presented by Arcadia organized under Cerebro ’23 - The annual Tech Fest of IIIT V .", style: TextStyle(color: Colors.white),).p16(),
            const SizedBox(height: 20,),
