...
class Prudentia extends StatefulWidget {
  @override
  State<Prudentia> createState() => _PrudentiaState();
}
...
class _PrudentiaState extends State<Prudentia> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: "PRUDENTIA".text.color(Colors.tealAccent).make(),
        centerTitle: true,
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            const Text("Prudentia-Unleash Your Inner Trader and join the Nationwide Virtual Stock Trading Revolution with Prudentia-A virtual stock trading event of CEREBRO", style: TextStyle(color: Colors.white),).p16(),
            const SizedBox(height: 20,),
