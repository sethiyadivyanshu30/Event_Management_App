...
class Register_Ventura extends StatefulWidget{
  @override
  State<Register_Ventura> createState() => _RegisterVenturaState();
}

class _RegisterVenturaState extends State<Register_Ventura>{
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: DropdownButtonFormField<String>(
                            ...
                            value: dropdownValue,
                            items: <String>['Cricket', 'Table Tennis',
                              'Football', 'Badminton', 'Volleyball'].map<DropdownMenuItem<String>>((String value) {
