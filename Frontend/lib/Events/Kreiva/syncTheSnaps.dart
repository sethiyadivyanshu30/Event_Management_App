...
class SyncTheSnaps extends StatefulWidget
{
  @override
  State<SyncTheSnaps> createState() => _SyncTheSnapsState();
}
class Item {
  String headerValue;
...
class _SyncTheSnapsState extends State<SyncTheSnaps>
{
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      appBar: AppBar(
        title: "SYNC THE SNAPS".text.color(Colors.tealAccent).make(),
        centerTitle: true,
      ...
      body: SafeArea(
        child: Column(
          children: [
            Image.asset(
              'Assets/images/syncTheSnaps2.jpg',
              fit: BoxFit.fill,
              width: 500,
            ),
            const SizedBox(
