...
class RetroDen extends StatefulWidget
{
  @override
  State<RetroDen> createState() => _RetroDenState();
}
class Item {
  String headerValue;
...
class _RetroDenState extends State<RetroDen>
{
  ...
  Widget build(BuildContext context)
  {
    ...
    return  Scaffold(
      appBar: AppBar(
        title: "RETRO DEN".text.color(Colors.tealAccent).make(),
        centerTitle: true,
