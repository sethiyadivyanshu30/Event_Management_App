...
class Kahanikar extends StatefulWidget
{
  @override
  State<Kahanikar> createState() => _KahanikarState();
}
class Item {
  String headerValue;
...
class _KahanikarState extends State<Kahanikar>
{
  ...
  Widget build(BuildContext context)
  {
    ...
    return  Scaffold(
      appBar: AppBar(
        title: "KAHANIKAR".text.color(Colors.tealAccent).make(),
        centerTitle: true,
