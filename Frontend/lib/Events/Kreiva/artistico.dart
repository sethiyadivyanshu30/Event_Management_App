...
class Artistico extends StatefulWidget {
  @override
  State<Artistico> createState() => _ArtisticoState();
}
class Item {
  String headerValue;
...
class _ArtisticoState extends State<Artistico> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: "ARTISTICO".text.color(Colors.tealAccent).make(),
        centerTitle: true,
