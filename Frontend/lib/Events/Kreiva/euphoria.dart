...
class Euphoria extends StatefulWidget
{
  @override
  State<Euphoria> createState() => _EuphoriaState();
}
class Item {
  String headerValue;
...
class _EuphoriaState extends State<Euphoria>
{
  ...
  Widget build(BuildContext context)
  {
    ...
    return  Scaffold(
      appBar: AppBar(
        title: "EUPHORIA".text.color(Colors.tealAccent).make(),
        centerTitle: true,
