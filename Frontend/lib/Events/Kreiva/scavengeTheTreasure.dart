...
class ScavengeTheTreasure extends StatefulWidget
{
  @override
  State<ScavengeTheTreasure> createState() => _ScavengeTheTreasureState();
}
class Item {
  String headerValue;
...
class _ScavengeTheTreasureState extends State<ScavengeTheTreasure>
{
  ...
  Widget build(BuildContext context)
  {
    ...
    return  Scaffold(
      appBar: AppBar(
        title: "SCAVENGE THE TREASURE".text.color(Colors.tealAccent).make(),
        centerTitle: true,
      ...
      body: SafeArea(
        child: Column(
          children: [
            Image.asset(
              'Assets/images/scavengeTheTreasure2.jpg',
              fit: BoxFit.fill,
              width: 500,
            ),
            const SizedBox(
